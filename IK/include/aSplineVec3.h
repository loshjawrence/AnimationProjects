...
float N(const std::vector<float>& knots, const unsigned int& n_rec, const unsigned int& t, const unsigned int& j);
float dN(const std::vector<float>& knots, const unsigned int& n_rec, const unsigned int& t, const unsigned int& j, const unsigned int& l);
